...
const Hero = () => {
    ...
    <section className="w-full h-[100vh] flex flex-col justify-center items-center gap-[10rem] px-[1rem] md:px-[10rem]" id="hero">
        ...
        <div className="dela-gothic--font text-4xl md:text-6xl self-start">
            <h1 className="mb-2">Hello,</h1>
            <h1>I'm <span className="text-[#B08EFF]">Rahul Yavvari</span></h1>

            <h1 className="mt-10 courier-prime--font text-3xl md:text-5xl text-[#6A6A6A]"><span className="text-[#007E00]"><span className="dela-gothic--font text-2xl md:text-4xl">$/</span></span> 
